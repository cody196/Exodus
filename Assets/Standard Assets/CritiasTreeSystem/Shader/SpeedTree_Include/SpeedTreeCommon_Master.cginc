...
#define master_LODFadeFull_arr Fading
...
void SpeedTreeFrag(Input IN, out SpeedTreeFragOut OUT)
{
...

	{
		...
		clip(UNITY_ACCESS_INSTANCED_PROP(master_LODFadeFull_arr, master_LODFadeFull) - thresholdMatrix[fmod(pos.x, 4)] * _RowAccess[fmod(pos.y, 4)]);
	}
